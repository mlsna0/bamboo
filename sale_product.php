        ...
        <div id="main">
            <div class="inner">
                <div class="content">
                    ...
                    <table border="0">
                        <tr>
                            <form id="form1" name="form1" method="GET" action='sale_search.php'>
                                <div class="row uniform">
                                    <div class="6u 12u$(xsmall)">
                                        <td> <label><font color='000000'>  รหัสการขาย </label> </td>
                                        <td> <input type="text" name="sale_id"> </td>
                                        <td> <label><font color='000000'>  วันที่การขาย  </label> </td>
                            ...
                            <form id="form2" name="form2" method="post" action="sale_insert.php">
                                <td> <input type="submit" name="btnAdd" value="บันทึกการขาย"> </td>
                            </form>
                </div>
            </div>
            </tr>
            ...
            <section>
                ...
                <td></td>
                <td></td>
                <td ><font color='blue'>ข้อมูลลูกค้า</td>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<tr bgcolor=''>";
					echo "<td align='center'><a href='sale_product_show.php?sale_id=$row[sale_id]'>" . $row["sale_id"] . "</a></td> ";
                    echo "<td></td>";
                    echo "<td></td>";
                    echo "<td></td>";
                    echo "<td ><a href='sale_customer_show.php?customer_id=$row[cus_id]'>" . $row["cus_id"] .' : '. $row["cus_name"] . '</a></td>';
                    echo "<td align='center'>" . $t_date_game ."</td> ";
					echo "<td align='center'><font color='#32CD32'>" . $row["sale_sts"] .  "</font></td> ";
					echo "</tr>";
                }
                echo "</table>";
