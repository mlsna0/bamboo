    ...
    <div id="wrapper">
        ...
        <div id="main">
            ...
            <section>
                ...
                $search = isset($_GET['sup_id']) ? $_GET['sup_id'] : '';
                $search1 = isset($_GET['sup_desc']) ? $_GET['sup_desc'] : '';
                $sql = "SELECT * FROM supplier WHERE sup_id LIKE '$search%'  ";
                $sql =  $sql."and  sup_desc LIKE '$search1%'  ";
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<td><a href='show_customer.php?sup_id=$row[0]'>" . $row["sup_id"] . "</a></td> ";
