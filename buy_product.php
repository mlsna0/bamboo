        ...
        <div id="main">
            <div class="inner">
                <div class="content">
                    <header>
                        <br />
                        <H3>การจัดการข้อมูลการรับสินค้า</H3>
                        </td>
                    </header>
                    <table border="0">
                        <tr>
                            <form id="form1" name="form1" method="GET" action='buy_search.php'>
                                <div class="row uniform">
                                    <div class="6u 12u$(xsmall)">
                                        <td> <label>
                                                <font color='000000'> เลขที่ใบรับสินค้า
                                            </label> </td>
                                        <td> <input type="text" name="buy_id"> </td>
                                        <td> <label>
                                                <font color='000000'> วันที่รับสินค้า
                                            </label> </td>
            ...
            <section>
                ...
                <td align='center'><font color='blue'>เลขที่ใบรับสินค้า</td>
                <td></td>
                <td></td>
                <td></td>
                <td ><font color='blue'>ข้อมูลตัวแทน</td>
                <td align='center'><font color='blue'>วันที่รับสินค้า</td>
                <td></td>
                <td align='center'><font color='blue'>สถานะ</td>
              </tr>";
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<td></td>";
                    echo "<td></td>";
                    echo "<td ><a href='buy_supplier_show.php?sup_id=$row[sup_id]'>" . $row["sup_id"] . ' : (' . $row["sup_desc"] . ')' . "</a></td> ";
