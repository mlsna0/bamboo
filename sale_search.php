    ...
    <div id="wrapper">
        ...
        <div id="main">
            ...
            <section>
                ...
                $search = isset($_GET['sale_id']) ? $_GET['sale_id'] : '';
                $search1 = isset($_GET['sale_date']) ? $_GET['sale_date'] : '';

                $query = "SELECT * FROM sale ,customer 
                WHERE sale.cus_id = customer.cus_id 
                AND sale.sale_id LIKE '%$search%'  
                AND sale_date LIKE '%$search1%' 
                ...
                while ($row = mysqli_fetch_array($result)) {
					...
					echo "<td align='center'><font color='#32CD32'>" . $row["s_type_code"] .  "</font></td> ";
					echo "</tr>";
                }
                echo "</table>";
