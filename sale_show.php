            ...
            <div class="inner">
                <div class="content">
                    ...
                    <section>
                        ...
                        <h3 align='left'>รายละเอียดการขาย <font color='blue'>$find_raw_id</font></h3>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td align='center'>&emsp;" .number_format($row['sale_price'],2)."</td>";
                            echo "<td align='center'> " .number_format($row['sale_price'] * $row['sale_amount'],2). "</td>";
                            echo "</tr>";
                        }
