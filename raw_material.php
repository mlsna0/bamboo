    ...
    <div id="wrapper">
        ...
        <div id="main">
                            ...
                            <form id="form1" name="form1" method="GET" action='search_raw_material.php'>
                                <div class="row uniform">
                                    <div class="6u 12u$(xsmall)">
                                        <td> <label> &nbsp; รหัสวัตถุดิบ </label> </td>
                                        <td> <input type="text" name="raw_id"> </td>
                                        <td> <label> &nbsp; ชื่อวัตถุดิบ &nbsp; </label> </td>
            ...
            <section>
                ...
                $query = "SELECT * FROM raw_material ORDER BY raw_id asc" or die("Error:" . mysqli_error());
