    ...
    <div id="wrapper">
        ...
        <div id="main">
            ...
            <section>
                ...
                $search = isset($_GET['prod_id']) ? $_GET['prod_id'] : '';
                $search1 = isset($_GET['prod_name']) ? $_GET['prod_name'] : '';
                $sql = "SELECT * FROM product WHERE prod_id LIKE '$search%'  ";
                $sql =  $sql."and  prod_name LIKE '$search1%'  ";
                ...
                while ($row = mysqli_fetch_array($result)) {
					...
					echo "<td><a href='show_product.php?prod_id=$row[0]'>" . $row["prod_id"] . "</a></td> ";
					echo "<td>" . $row["prod_name"] .  "</td> ";
					echo "<td>" . $row["prod_amount"] .  "</td> ";
					echo "<td>" . $row["prod_cost"] .  "</td> ";
					echo "<td>" . $row["prod_price"] .  "</td> ";
					echo "<td><a href='edit_product.php?product_id=$row[0]'><img src=./images/edit.gif></a></td> ";
                    echo "<td><a href='edit_img.php?product_id=$row[0]'><img src=./images/img.gif></a></td> ";
					echo "</tr>";
                }
                echo "</table>";
