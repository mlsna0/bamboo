        ...
        <div id="main">
            <div class="inner">
                <div class="content">
                    ...
                    $sale_id = $_GET["sale"];
                    $query = "SELECT * FROM sale,customer, sale_status  
                    WHERE sale.cus_id = customer.cus_id and
                        sale.sts = sale_status.sale.sts and 
                    ...
                    <h4 align="center"> สถานะการขาย : <font color="blue"><?php echo $data['sale.sts']; ?></font>
                    </h4>
